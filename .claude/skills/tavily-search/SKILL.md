...
```bash
bun {baseDir}/scripts/search.mjs "query"
bun {baseDir}/scripts/search.mjs "query" -n 10
bun {baseDir}/scripts/search.mjs "query" --deep
bun {baseDir}/scripts/search.mjs "query" --topic news
```
...
```bash
# Basic search
bun {baseDir}/scripts/search.mjs "python async patterns"

# With more results
bun {baseDir}/scripts/search.mjs "React hooks tutorial" -n 10

# Advanced search
bun {baseDir}/scripts/search.mjs "machine learning" --deep

# News search
bun {baseDir}/scripts/search.mjs "AI news" --topic news

# Domain-filtered search
bun {baseDir}/scripts/search.mjs "Python docs" --include-domains docs.python.org
```
