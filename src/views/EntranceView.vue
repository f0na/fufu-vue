...
<template>
    <div class="relative size-full overflow-hidden md:size-screen">
        ...
        <!-- 内容层 -->
        <div class="relative min-h-screen md:absolute md:inset-0 flex items-center justify-center p-6 overflow-y-auto md:overflow-hidden"
                ...
                <div class="w-fit grid grid-cols-2 gap-[18px]">
                    ...
                    <div class="translate-x-[3px] -translate-y-[3px]">
                        <div class="transition-all duration-700 ease-out"
                            :class="is_entering ? '-translate-x-[150%] -translate-y-[40%] opacity-0' : 'translate-x-0 translate-y-0 opacity-100'">
                            <profile-card />
                        </div>
                    </div>
                    ...
                    <div class="-translate-x-[3px] -translate-y-[-40px]">
                        <div class="transition-all duration-700 delay-100 ease-out"
                            :class="is_entering ? 'translate-x-[150%] -translate-y-[40%] opacity-0' : 'translate-x-0 translate-y-0 opacity-100'">
                            <random-gallery />
                        </div>
                    </div>
