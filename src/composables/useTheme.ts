...
function apply_theme(theme: ThemeConfig) {
  ...
  root.style.setProperty('--c-primary-light', theme.colors.primary_light)
  root.style.setProperty('--c-primary-bg', theme.colors.primary_bg)
  root.style.setProperty('--c-border', theme.colors.border)
  root.style.setProperty('--c-secondary', theme.colors.secondary)
  root.style.setProperty('--c-tag-bg', theme.colors.tag_bg)
  root.style.setProperty('--c-tag-text', theme.colors.tag_text)
