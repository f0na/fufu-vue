    ...
    routes: [
        { path: '/', name: 'entrance', component: () => import('@/views/EntranceView.vue') },
        {
            ...
            children: [
                ...
                { path: 'bangumi/:id', name: 'bangumi-detail', component: () => import('@/components/bangumi/BangumiDetail.vue') },
                { path: 'links', name: 'links', component: () => import('@/components/links/LinksSection.vue') },
                { path: 'friends', name: 'friends', component: () => import('@/components/friends/FriendsSection.vue') },
                { path: 'admin', name: 'admin', component: () => import('@/components/admin/AdminPage.vue') },
