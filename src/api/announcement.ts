...
// 更新公告
export function update_announcement(id: string, data: UpdateAnnouncementRequest): Promise<Announcement> {
...
// 切换公告可见性
export function toggle_announcement_visibility(id: string, visible: boolean): Promise<{ id: string; visible: boolean }> {
