...
import type { Comment, CreateCommentRequest, CreateGuestCommentRequest, PaginatedData, CommentTarget, UploadResponse, SensitiveWord } from './types'
...
export function get_comments(params: {
    ...
    return get<PaginatedData<Comment>>('/comments', { params })
}
