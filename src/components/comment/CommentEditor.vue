    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="flex items-center justify-between px-1">
            <button
                ...
                :class="edit_mode === 'markdown' ? 'bg-[var(--c-primary-bg)] text-[var(--c-primary)]' : 'text-slate-500 hover:text-[var(--c-primary)]'"
            >
        ...
        >
            ...
            <div
                v-else
                class="comment-preview whitespace-pre-wrap break-words"
            >
                {{ content }}
            </div>
        </div>
