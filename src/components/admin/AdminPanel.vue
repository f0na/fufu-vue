...
<template>
    <div class="fixed inset-0 z-[100] flex items-center justify-center">
        ...
        <!-- 面板 -->
        <div class="relative w-full max-w-3xl max-h-[80vh] bg-white rounded-xl shadow-xl overflow-hidden flex flex-col">
            <!-- 标题栏 -->
            <div class="flex items-center justify-between px-6 py-4 border-b border-[var(--c-border)]">
                <h2 class="text-lg font-medium text-slate-700">管理面板</h2>
                <button
                    @click="$emit('close')"
