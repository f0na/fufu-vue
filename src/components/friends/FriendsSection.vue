...
// 模拟友链列表数据（实际应从 API 获取）
const all_friends = ref<Friend[]>([
    { id: '1', name: 'Mizuki', url: 'https://mizuki.mysqil.com', description: '一个可爱的个人博客', status: 'active', visible: true, sort_order: 0, created_at: '2026-01-01', updated_at: '2026-01-01' },
    { id: '2', name: 'Hexo', url: 'https://hexo.io', description: '快速、简洁且高效的博客框架', status: 'active', visible: true, sort_order: 1, created_at: '2026-01-01', updated_at: '2026-01-01' },
    { id: '3', name: 'Vue.js', url: 'https://vuejs.org', description: '渐进式 JavaScript 框架', status: 'active', visible: true, sort_order: 2, created_at: '2026-01-01', updated_at: '2026-01-01' },
    { id: '4', name: 'GitHub', url: 'https://github.com', description: '全球最大的代码托管平台', status: 'active', visible: true, sort_order: 3, created_at: '2026-01-01', updated_at: '2026-01-01' },
    { id: '5', name: 'Bilibili', url: 'https://bilibili.com', description: '国内知名视频弹幕网站', status: 'active', visible: true, sort_order: 4, created_at: '2026-01-01', updated_at: '2026-01-01' },
    { id: '6', name: 'Twitter', url: 'https://twitter.com', description: '社交媒体平台', status: 'active', visible: true, sort_order: 5, created_at: '2026-01-01', updated_at: '2026-01-01' },
])
...
const filtered_friends = computed(() => {
    ...
    return all_friends.value.filter(f =>
...
<template>
    <div class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
                <!-- 网站图标 -->
                <div class="w-12 h-12 rounded-xl bg-[var(--c-primary-bg)] flex items-center justify-center shrink-0 overflow-hidden">
                    <img
                ...
                <!-- 访问图标 -->
                <div class="i-lucide-arrow-up-right w-4 h-4 text-slate-300 group-hover:text-[var(--c-primary)] transition-colors shrink-0" />
            </div>
        </div>
