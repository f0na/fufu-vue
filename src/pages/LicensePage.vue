...
const license_text = `TERMS AND CONDITIONS FOR USE, REPRODUCTION, AND DISTRIBUTION
...
<template>
  <PageWrapper current_page="archive">
    ...
    >
      <Card>
        <CardHeader>
          <CardTitle class="text-xl">Apache License, Version 2.0</CardTitle>
          <p class="text-sm text-muted-foreground">
            Copyright &copy; {{ new Date().getFullYear() }} fufu
          </p>
        </CardHeader>
        <CardContent>
          ...
          <pre class="text-xs text-muted-foreground leading-relaxed whitespace-pre-wrap font-sans">{{ license_text }}</pre>
        </CardContent>
      </Card>
    </HomeLayout>
  </PageWrapper>
