  ...
  <PageWrapper>
    ...
    >
      <div class="bg-card/80 backdrop-blur-sm rounded-xl border border-border p-6">
        <h1 class="text-2xl font-semibold text-foreground">网站介绍</h1>
        <p class="text-muted-foreground leading-relaxed">这里是可爱芙芙的小窝，欢迎大家^^</p>
        <p class="text-muted-foreground leading-relaxed">
          这里是我的个人空间，记录着生活中的点点滴滴。
        </p>
        <p class="text-muted-foreground leading-relaxed">网站正在建设中，敬请期待更多内容。</p>
      </div>
    </HomeLayout>
  </PageWrapper>
</template>
